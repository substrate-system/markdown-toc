...
1. `$ npm install -g @substrate-system/markdown-toc`
...
```js
import {Remarkable, toc} from '@substrate-system/markdown-toc'
...
```js
import {toc} from '@substrate-system/markdown-toc'
```
