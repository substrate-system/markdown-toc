...
import { Remarkable, toc } from '../src/index.js'
...
test('preserves front matter while inserting', async t => {
    ...
    assert.equal(toc.insert(markdown).trim(), expected.trim())
    t.ok(toc.insert(markdown).startsWith('---'),
